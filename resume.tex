...
\textbf{KREDIVO GROUP} \\
\textit{Software Engineer, Backend (SDE 2)} \hfill Dec 2025 -- Present
\begin{itemize}
    \item Part of the User team, responsible for the core User microservices that handle Registration, Approval Engine, Limit Management, and Account Management.
    \item Developed and maintained backend services using Python, FastAPI, and Django, backed by MySQL and deployed on AWS.
    \item Ensured reliability and scalability of user-facing services within a microservices architecture serving a large user base.
\end{itemize}\\
\textbf{ECOMINDO (PT. ECOMINDO SARANACIPTA)} \\
\textit{Associate Software Engineer} \hfill Jul 2024 -- Nov 2025
\begin{itemize}
...
\textbf{Tech Stack:} & Typescript, Javascript, Java, React, React Native, Quarkus, Next, Gatsby, Python, FastAPI, Django, Django Rest, Go, Postgresql, MySQL, Kafka, AWS \\
\end{tabularx}
\textbf{Achievements:}
\begin{itemize}
